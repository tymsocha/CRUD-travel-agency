...
public class TripMapper {
    public Trip mapTripDTOToTrip(TripDTO tripDTO) {
        return Trip.builder()
                ...
                .tickets(tripDTO.getTickets())
                .carReservations(tripDTO.getCarReservations())
                .hotelReservations(tripDTO.getHotelReservations())
    ...
    public TripDTO mapTripToTripDTO(Trip trip) {
        return TripDTO.builder()
                ...
                .carReservations(trip.getCarReservations())
                .hotelReservations(trip.getHotelReservations())
