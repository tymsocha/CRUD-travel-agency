...
public class HotelFacadeTestSuite {
    @Autowired
    ...
    public void shouldGetAllHotels() {
        ...
        dao.save(hotel2);
        //When
        List<HotelDTO> hotels = facade.getHotels();
        //Then
    ...
    public void shouldFindHotelById() {
        ...
        //When and then
        try {
            HotelDTO foundHotel = facade.getHotel(savedHotel.getId());
    ...
    public void shouldDeleteHotel() {
        ...
        Hotel savedHotel = dao.save(hotel);
        //When
        facade.deleteHotel(savedHotel.getId());
        List<HotelDTO> hotels = facade.getHotels();
        //Then
